...
# 各个状态的依赖项
func setup(context_ball:Ball, context_player_dection_area: Area2D, context_carrier: Player, context_animation_player: AnimationPlayer, context_sprite: Sprite2D, context_state_data: BallStateData, context_shot_particles: GPUParticles2D) -> void:
	ball = context_ball
